...
# title/icon; flaticon.com (32px)
pygame.display.set_caption("YO MAN")
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load("heisenberg.png"))
...
while running:
    ...
    # Checking for boundaries so doesn't go out of bounds
